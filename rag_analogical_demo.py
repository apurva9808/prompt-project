"""
RAG "Chat with Your Documents" - Analogical Prompting Demo
"""
...
TEST_QUESTION = "How would you describe this candidate's overall experience and strengths to a non-technical hiring manager?"
...
def run_demo():
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "Use a simple analogy to explain, but do not add new facts."
            ),
        },
        {
            "role": "user",
    ...
    print("=" * 80)
    print("ANALOGICAL PROMPTING DEMO")
    print("=" * 80)
    print(f"Question: {TEST_QUESTION}\n")
    print("Response:")
    print(response.choices[0].message.content)
    print("\nNote: Analogy helps clarity without adding facts.")
